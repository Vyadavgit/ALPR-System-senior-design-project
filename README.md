...
<br>
Run license detection program: ***python detect.py***
<br>
***IMPORTANT NOTE:*** Install Tesseract-OCR in the 'site-packages' folder of your virtual environment and provide path to it in 'detect.py' file for the license detection and OCR program to work well.
